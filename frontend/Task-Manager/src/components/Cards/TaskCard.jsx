  ...
  onClick
    ...
    const getStatusTagColor = () => {
        switch (status) {
            ...
            default:
                return "text-voilet-500 bg-voilet-50 border border-violet-500/10"
        }
    };
    ...
    >
       <div className="flex items-end gap-3 px-4">
        ...
        >
            ...
            <p className="text-x font-medium text-gray-800 line-clamp-2">
                {title}
            </p>
            ...
            <p className="text-[15px] text-gray-700/80 font-medium mt-2 leading-[18px]">
                Task Done:{" "}
